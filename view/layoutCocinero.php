                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <a href="index.php?action=listarAlimentosC"><i class="fa fa-cutlery fa-fw"></i> Administrar de Alimentos</a>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <a href="index.php?action=listarPlatosC"><i class="fa fa-cutlery fa-fw"></i> Administrar de Platos</a>
                    ...
                    <ul class="nav ">
                      <li >
                                   <a href="index.php?action=listarOrdenesC"><i class="fa fa-archive fa-fw"></i>  Listar Ordenes</a>
                      </li>
                      </ul>
                </div>
                <!-- /.sidebar-collapse -->
